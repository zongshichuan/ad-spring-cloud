...
import com.chuan.ad.dto.ParseTemplate;
import com.chuan.ad.dto.TableTemplate;
import com.chuan.ad.dto.Template;
...
public class TemplateHolder {
    ...
    /**
     * 获取数据库表的元信息，实现列索引到列名的映射
     *
     * 也是填充ParseTemplate中tableTemplateMap中value(TableTemplate)中的posMap(字段索引 -> 字段名)属性
     */
    private void loadMeta() {
        ...
        for (Map.Entry<String, TableTemplate> entry :
            ...
            jdbcTemplate.query(SQL_SCHEMA, new Object[]{
                ...
                /**
                 * 可以执行select table_schema, table_name,column_name, ordinal_position from information_schema.columns
                 * where table_schema = "ad_data" and table_name = "ad_plan"
                 * 查看ordinal_position和column_name关系
                 */
